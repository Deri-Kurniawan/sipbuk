...
const AdminCreateSymptom = ({ user, symptom }: AdminCreateProps) => {
  ...
  const onSubmitHandler = async (e: any) => {
    ...
    toast.promise(
      fetchCreatePestOrDesease()
        ...
        .catch(() => {
          toast.error(
            "Sistem gagal menyimpan data, ada kesalahan pada sistem",
            {
              duration: 5000,
            }
          );
  ...
  return (
    <>
      <Head>
        <title>
          Ubah Data Gejala [G{symptom.code}]: {symptom.info} - SIPBUK Admin
        </title>
        <meta
          name="description"
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:gap-8 lg:justify-center lg:items-center">
              <div className="flex justify-center w-full lg:justify-start">
                <div className="rounded-md bg-primary">
                  <Image
                    className="object-cover w-[480px] h-[432px] rounded-md"
                    src={
                      !selectedImageUrl
                ...
                <div className="form-control">
                  ...
                  <label className="rounded-md input-group">
                    <input
                      type="text"
                      name="info"
                      placeholder="Ciri-Ciri Gejala"
                      className="w-full input input-bordered"
                      id="info"
                      required
                      disabled={fetchIsLoading}
                      defaultValue={symptom.info}
                    />
                  </label>
                </div>
                <div className="form-control">
